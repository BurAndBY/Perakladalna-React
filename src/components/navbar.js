      ...
      <header data-thq="thq-navbar" className="navbar-navbar-interactive">
        ...
        >
          ...
          >
            ...
            <Link to="/games" className="navbar-navlink2">
              {props.text1}
            </Link>
            <a
        ...
        <div data-thq="thq-burger-menu" className="navbar-burger-menu">
          <svg fill="white" viewBox="0 0 1024 1024" className="navbar-icon">
            <path
        ...
        <div data-thq="thq-mobile-menu" className="navbar-mobile-menu">
          ...
          >
            ...
            >
              ...
              <span href="/Games" className="navbar-text1">
                Гульні
              </span>
              <span href="https://dsc.gg/perakladi" className="navbar-text2">
                Discord
              </span>
              <span href="/About-Us" className="navbar-text3">
                Пра нас
              </span>
            </nav>
          </div>
...
Navbar.defaultProps = {
  text2: 'Discord',
  rootClassName: '',
  Logo_src: '/playground_assets/peralogo-1500h.png',
  text4: 'Гульні',
  text5: 'Discord',
  Logo_alt: 'logo',
  text3: 'Пра Нас',
  text1: 'Гульні',
  image_alt: 'image',
  image_src: '/playground_assets/peralogo-1500h.png',
  text: 'Галоўная',
  text6: 'Пра нас',
  Text: 'Галоўная',
}
